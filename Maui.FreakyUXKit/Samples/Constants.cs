...
public static class Constants
{
    ...
    public static readonly string MeatballMenu = ResourcePath + "meatball_icon.svg";
    public static readonly string BackButton = ResourcePath + "back_button.svg";
    public static readonly string PlayButton = ResourcePath + "play.svg";
    public static readonly string BarChart = ResourcePath + "bar_chart.svg";
    ...
    public static readonly string Profile1 = "https://i.stack.imgur.com/BJXub.png?s=256&g=1";
    public static readonly string Profile2 = "https://i.stack.imgur.com/HOUoK.jpg?s=256&g=1";
    public static readonly string Profile3 = "https://i.stack.imgur.com/yzJsY.jpg?s=256&g=1";
